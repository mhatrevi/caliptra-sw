...
impl<TMmio: caliptra_ureg::Mmio> RegisterBlock<TMmio> {
    ...
    /// Selects which RISC-V core is muxed onto the caliptra_top trace_rv_i_* ports.
    /// [br]0 = main core (default), 1 = shadow (lockstep) core.
    /// [br]Reset value selects the main core.
    /// [br]Caliptra Access: RW
    /// [br]SOC Access:      None (writes rejected via swwel)
    ///
    /// Read value: [`soc_ifc::regs::InternalTraceCtrlReadVal`]; Write value: [`soc_ifc::regs::InternalTraceCtrlWriteVal`]
    #[inline(always)]
    pub fn internal_trace_ctrl(
        &self,
    ) -> caliptra_ureg::RegRef<crate::soc_ifc::meta::InternalTraceCtrl, &TMmio> {
        unsafe {
            caliptra_ureg::RegRef::new_with_mmio(
                self.ptr.wrapping_add(0x664 / core::mem::size_of::<u32>()),
                core::borrow::Borrow::borrow(&self.mmio),
            )
        }
    }
...
pub mod regs {
    ...
    impl CptraHwConfigReadVal {
        ...
        /// Caliptra core DCLS enabled
        #[inline(always)]
        pub fn dcls_en(&self) -> bool {
            ((self.0 >> 8) & 1) != 0
        }
    }
    ...
    impl CptraHwErrorFatalReadVal {
        ...
        #[inline(always)]
        pub fn rv_dcls_err(&self) -> bool {
            ((self.0 >> 7) & 1) != 0
        }
        #[inline(always)]
        pub fn dccm_wr_readback_err(&self) -> bool {
            ((self.0 >> 8) & 1) != 0
        }
        #[inline(always)]
    ...
    impl CptraHwErrorFatalWriteVal {
        ...
        #[inline(always)]
        pub fn rv_dcls_err(self, val: bool) -> Self {
            Self((self.0 & !(1 << 7)) | (u32::from(val) << 7))
        }
        #[inline(always)]
        pub fn dccm_wr_readback_err(self, val: bool) -> Self {
    ...
    impl InternalHwErrorFatalMaskReadVal {
        ...
        #[inline(always)]
        pub fn mask_rv_dcls_err(&self) -> bool {
            ((self.0 >> 7) & 1) != 0
        }
        #[inline(always)]
        pub fn mask_dccm_wr_readback_err(&self) -> bool {
            ((self.0 >> 8) & 1) != 0
        }
        /// Construct a WriteVal that can be used to modify the contents of this register value.
        #[inline(always)]
    ...
    impl InternalHwErrorFatalMaskWriteVal {
        ...
        #[inline(always)]
        pub fn mask_dccm_wr_readback_err(self, val: bool) -> Self {
            Self((self.0 & !(1 << 8)) | (u32::from(val) << 8))
        }
    }
    ...
    #[derive(Clone, Copy)]
    pub struct InternalTraceCtrlReadVal(u32);
    impl InternalTraceCtrlReadVal {
        /// Trace port core select: 0 = main core, 1 = shadow (lockstep) core.
        #[inline(always)]
        pub fn trace_shadow_core_sel(&self) -> bool {
            ((self.0 >> 0) & 1) != 0
        }
        /// Construct a WriteVal that can be used to modify the contents of this register value.
        #[inline(always)]
        pub fn modify(self) -> InternalTraceCtrlWriteVal {
            InternalTraceCtrlWriteVal(self.0)
        }
    }
    impl From<u32> for InternalTraceCtrlReadVal {
        #[inline(always)]
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<InternalTraceCtrlReadVal> for u32 {
        #[inline(always)]
        fn from(val: InternalTraceCtrlReadVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
    pub struct InternalTraceCtrlWriteVal(u32);
    impl InternalTraceCtrlWriteVal {
        /// Trace port core select: 0 = main core, 1 = shadow (lockstep) core.
        #[inline(always)]
        pub fn trace_shadow_core_sel(self, val: bool) -> Self {
            Self((self.0 & !(1 << 0)) | (u32::from(val) << 0))
        }
    }
    impl From<u32> for InternalTraceCtrlWriteVal {
        #[inline(always)]
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<InternalTraceCtrlWriteVal> for u32 {
        #[inline(always)]
        fn from(val: InternalTraceCtrlWriteVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
...
pub mod meta {
    ...
    >;
    pub type InternalTraceCtrl = caliptra_ureg::ReadWriteReg32<
        0,
        crate::soc_ifc::regs::InternalTraceCtrlReadVal,
        crate::soc_ifc::regs::InternalTraceCtrlWriteVal,
    >;
