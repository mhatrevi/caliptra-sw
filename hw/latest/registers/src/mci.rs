...
// caliptra-ss: 4fb99b4dadc235e5989fa594dcd38894851676a1
// caliptra-rtl: c46bf7ca8e0b6dd1c82aa812073c02d6cd8c4fbd
// adams-bridge: 2f15ffb1a2e9bd99652fa04d434a48ffcdc23f42
// i3c-core: 067bfe14ea8bb54470b6af9af154bee5cda6ded7
...
impl<TMmio: caliptra_ureg::Mmio> RegisterBlock<TMmio> {
    ...
    ///
    /// Read value: [`mci::regs::HwCapabilitiesReadVal`]; Write value: [`mci::regs::HwCapabilitiesWriteVal`]
    #[inline(always)]
...
pub mod regs {
    ...
    #[derive(Clone, Copy)]
    pub struct HwCapabilitiesReadVal(u32);
    impl HwCapabilitiesReadVal {
        /// Selects the streaming boot interface and recovery signal routing.
        /// [br]Unsupported or illegal values default to USB streaming boot.
        #[inline(always)]
        pub fn streaming_boot_select(&self) -> super::enums::StreamingBootSelectE {
            super::enums::StreamingBootSelectE::try_from((self.0 >> 0) & 3).unwrap()
        }
        /// Caliptra core dual-core lockstep (DCLS) corruption detection is ENABLED
        /// by default (reset 0). Setting this bit to 1 DISABLES DCLS corruption
        /// detection (drives ss_dcls_en=0 to the Caliptra core). This disable is
        /// intended only as a break-glass control for a late DCLS bug or for debug,
        /// and MCU ROM should set it solely based on a permanent indication such as
        /// a fuse. Lock via CAP_LOCK after configuration to make the selection
        /// immutable until warm reset.
        #[inline(always)]
        pub fn cptra_core_dcls_corruption_detection_disable(&self) -> bool {
            ((self.0 >> 2) & 1) != 0
        }
        /// Remaining hardware capability bits.
        #[inline(always)]
        pub fn cap(&self) -> u32 {
            (self.0 >> 3) & 0x1fffffff
        }
        /// Construct a WriteVal that can be used to modify the contents of this register value.
        #[inline(always)]
        pub fn modify(self) -> HwCapabilitiesWriteVal {
            HwCapabilitiesWriteVal(self.0)
        }
    }
    impl From<u32> for HwCapabilitiesReadVal {
        #[inline(always)]
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<HwCapabilitiesReadVal> for u32 {
        #[inline(always)]
        fn from(val: HwCapabilitiesReadVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
    pub struct HwCapabilitiesWriteVal(u32);
    impl HwCapabilitiesWriteVal {
        /// Selects the streaming boot interface and recovery signal routing.
        /// [br]Unsupported or illegal values default to USB streaming boot.
        #[inline(always)]
        pub fn streaming_boot_select(
            self,
            f: impl FnOnce(
                super::enums::selector::StreamingBootSelectESelector,
            ) -> super::enums::StreamingBootSelectE,
        ) -> Self {
            Self(
                (self.0 & !(3 << 0))
                    | (u32::from(f(super::enums::selector::StreamingBootSelectESelector())) << 0),
            )
        }
        /// Caliptra core dual-core lockstep (DCLS) corruption detection is ENABLED
        /// by default (reset 0). Setting this bit to 1 DISABLES DCLS corruption
        ...
        /// immutable until warm reset.
        #[inline(always)]
        pub fn cptra_core_dcls_corruption_detection_disable(self, val: bool) -> Self {
            Self((self.0 & !(1 << 2)) | (u32::from(val) << 2))
        }
        /// Remaining hardware capability bits.
        #[inline(always)]
        pub fn cap(self, val: u32) -> Self {
            Self((self.0 & !(0x1fffffff << 3)) | ((val & 0x1fffffff) << 3))
        }
    }
    impl From<u32> for HwCapabilitiesWriteVal {
        #[inline(always)]
        fn from(val: u32) -> Self {
            Self(val)
        }
    }
    impl From<HwCapabilitiesWriteVal> for u32 {
        #[inline(always)]
        fn from(val: HwCapabilitiesWriteVal) -> u32 {
            val.0
        }
    }
    #[derive(Clone, Copy)]
...
pub mod enums {
    ...
    #[derive(Clone, Copy, Eq, PartialEq)]
    #[repr(u32)]
    pub enum StreamingBootSelectE {
        Usb = 0,
        I3c = 1,
        Axi = 2,
        Reserved = 3,
    }
    impl StreamingBootSelectE {
        #[inline(always)]
        pub fn usb(&self) -> bool {
            *self == Self::Usb
        }
        #[inline(always)]
        pub fn i3c(&self) -> bool {
            *self == Self::I3c
        }
        #[inline(always)]
        pub fn axi(&self) -> bool {
            *self == Self::Axi
        }
        #[inline(always)]
    ...
    impl TryFrom<u32> for StreamingBootSelectE {
        type Error = ();
        #[inline(always)]
        fn try_from(val: u32) -> Result<StreamingBootSelectE, ()> {
            if val < 4 {
                Ok(unsafe { core::mem::transmute::<u32, StreamingBootSelectE>(val) })
            } else {
                Err(())
            }
        }
    }
    impl From<StreamingBootSelectE> for u32 {
        fn from(val: StreamingBootSelectE) -> Self {
            val as u32
        }
    }
    pub mod selector {
        ...
        pub struct StreamingBootSelectESelector();
        impl StreamingBootSelectESelector {
            #[inline(always)]
            pub fn usb(&self) -> super::StreamingBootSelectE {
                super::StreamingBootSelectE::Usb
            }
            #[inline(always)]
            pub fn i3c(&self) -> super::StreamingBootSelectE {
                super::StreamingBootSelectE::I3c
            }
            #[inline(always)]
            pub fn axi(&self) -> super::StreamingBootSelectE {
                super::StreamingBootSelectE::Axi
            }
            #[inline(always)]
            pub fn reserved(&self) -> super::StreamingBootSelectE {
                super::StreamingBootSelectE::Reserved
            }
        }
    }
}
pub mod meta {
    ...
    pub type HwCapabilities = caliptra_ureg::ReadWriteReg32<
        0,
        crate::mci::regs::HwCapabilitiesReadVal,
        crate::mci::regs::HwCapabilitiesWriteVal,
    >;
