...
pub struct PcrSigningCertTbsEcc384Params<'a> {
...
impl PcrSigningCertTbsEcc384Params<'_> {
...
pub struct PcrSigningCertTbsEcc384 {
    tbs: [u8; Self::TBS_TEMPLATE_LEN],
}
impl PcrSigningCertTbsEcc384 {
    ...
    const SUBJECT_KEY_ID_OFFSET: usize = 535usize;
    const AUTHORITY_KEY_ID_OFFSET: usize = 568usize;
    const UEID_OFFSET: usize = 487usize;
    ...
    pub const TBS_TEMPLATE_LEN: usize = 588usize;
    const TBS_TEMPLATE_BEFORE_KEY: [u8; Self::PUBLIC_KEY_OFFSET] = [
        48u8, 130u8, 2u8, 72u8, 160u8, 3u8, 2u8, 1u8, 2u8, 2u8, 20u8, 95u8, 95u8, 95u8, 95u8, 95u8,
        ...
        95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 95u8, 48u8, 117u8, 49u8,
        40u8, 48u8, 38u8, 6u8, 3u8, 85u8, 4u8, 3u8, 12u8, 31u8, 67u8, 97u8, 108u8, 105u8, 112u8,
        116u8, 114u8, 97u8, 32u8, 50u8, 46u8, 49u8, 32u8, 69u8, 99u8, 99u8, 51u8, 56u8, 52u8, 32u8,
        80u8, 67u8, 82u8, 32u8, 83u8, 105u8, 103u8, 110u8, 105u8, 110u8, 103u8, 49u8, 73u8, 48u8,
    ...
    pub fn new(params: &PcrSigningCertTbsEcc384Params) -> Self {
    ...
    fn apply(&mut self, params: &PcrSigningCertTbsEcc384Params) {
        #[inline(always)]
